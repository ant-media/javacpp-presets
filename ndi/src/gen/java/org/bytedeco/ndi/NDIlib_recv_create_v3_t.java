...
public class NDIlib_recv_create_v3_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public NDIlib_recv_create_v3_t() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public NDIlib_recv_create_v3_t(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public NDIlib_recv_create_v3_t(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public NDIlib_recv_create_v3_t position(long position) {
        return (NDIlib_recv_create_v3_t)super.position(position);
    }
    @Override public NDIlib_recv_create_v3_t getPointer(long i) {
        return new NDIlib_recv_create_v3_t((Pointer)this).offsetAddress(i);
    }

	// The source that you wish to connect to.
	public native @ByRef NDIlib_source_t source_to_connect_to(); public native NDIlib_recv_create_v3_t source_to_connect_to(NDIlib_source_t setter);

	// Your preference of color space. See above.
	public native @Cast("NDIlib_recv_color_format_e") int color_format(); public native NDIlib_recv_create_v3_t color_format(int setter);
	...
	// on WIFI connections.
	public native @Cast("NDIlib_recv_bandwidth_e") int bandwidth(); public native NDIlib_recv_create_v3_t bandwidth(int setter);
	...
	public native @Cast("bool") boolean allow_video_fields(); public native NDIlib_recv_create_v3_t allow_video_fields(boolean setter);
	...
	public native @Cast("const char*") BytePointer p_ndi_recv_name(); public native NDIlib_recv_create_v3_t p_ndi_recv_name(BytePointer setter);
